...
class ShoppingsControllerTest < ActionController::TestCase
  ...
  test "should create shopping" do
    assert_difference('Shopping.count') do
      post :create, shopping: { contactp: @shopping.contactp, contactt: @shopping.contactt, mail: @shopping.mail, products: @shopping.products, tel: @shopping.tel, type: @shopping.type }
    end
  ...
  test "should update shopping" do
    patch :update, id: @shopping, shopping: { contactp: @shopping.contactp, contactt: @shopping.contactt, mail: @shopping.mail, products: @shopping.products, tel: @shopping.tel, type: @shopping.type }
    assert_redirected_to shopping_path(assigns(:shopping))
  end
