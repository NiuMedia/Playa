...
class TransportsControllerTest < ActionController::TestCase
  ...
  test "should create transport" do
    assert_difference('Transport.count') do
      post :create, transport: { cel: @transport.cel, contactp: @transport.contactp, contactt: @transport.contactt, mail: @transport.mail, tel: @transport.tel, type: @transport.type }
    end
  ...
  test "should update transport" do
    patch :update, id: @transport, transport: { cel: @transport.cel, contactp: @transport.contactp, contactt: @transport.contactt, mail: @transport.mail, tel: @transport.tel, type: @transport.type }
    assert_redirected_to transport_path(assigns(:transport))
  end
